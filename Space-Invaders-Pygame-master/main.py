...
icon = pygame.image.load('Space-Invaders-Pygame-master/BigChickenCIU.png')
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load('Space-Invaders-Pygame-master/BigChickenCIU.png'))
...
# 🎁 Gift class 
class Gift:
    def __init__(self, image_path, bonus_points):
...
# Create a gift object (do this before the loop)
gift = Gift("Space-Invaders-Pygame-master/gift.png", bonus_points=5)
...
# 🎁 Gift movement and drawing
    gift.move()
    gift.draw(screen)

    # 🎁 Gift collision check
    if gift.is_collision(playerX, playerY):
        score_value += gift.bonus_points
        gift.reset_position()
